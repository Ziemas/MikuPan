...
u_char PosInAreaJudgeSub(int *addr, u_short pos_x, u_short pos_y, u_char type)
{
    ...
    if (type == 2)
    {
        if ((GET(short, 0) * pos_x) + (GET(short, 2) * pos_y) + GET(int, 4) <= 0
            && (GET(short, 8) * pos_x) + (GET(short, 10) * pos_y) + GET(int, 12)
                   <= 0
            && (GET(short, 16) * pos_x) + (GET(short, 18) * pos_y)
                       + GET(int, 20)
                   >= 0
            && (GET(short, 24) * pos_x) + (GET(short, 26) * pos_y)
                       + GET(int, 28)
                   >= 0)
        {
            return 1;
...
void Get2DLinearConstFromPos(float *a, float *b, float *c, float x0, float y0,
                             float x1, float y1)
{
    *a = y0 - y1;
    *b = x1 - x0;
...
int Get2DLinearCrossPoint(float *cpx, float *cpy, float a0, float b0, float c0,
...
int ChkLineCross(float x0, float y0, float x1, float y1, float x2, float y2,
                 float x3, float y3)
{
    float a0;
    float b0;
...
int ChkInsideBox(float cpx, float cpy, float x0, float y0, float x1, float y1,
