...
static void DspSaveTitle(u_char type, short int pos_x, short int pos_y,
...
char SavePointMenuMain(u_char msn)
{
            ...
            switch (McAtLoadChk(2))
            {
                ...
                case 1:
                    if (dsp_svp.in_album != 0)
                    {
                        ...
                        MemAlbmInit2(1, mc_photo_num, mc_album_type,
                                     mc_ctrl.port + 1, mc_ctrl.sel_file + 1);

                        sp_load_id = AlbmDesignLoadInGame(0, 5);
                        sp_load_id = AlbmDesignLoadInGame(1, mc_album_type);
#ifdef BUILD_EU_VERSION
                        sp_load_id =
                            LoadReqLanguage(PL_ALBM_E_PK2, LOAD_ADDRESS_2);
#else
                    ...
                    else
                    {
                        ...
                        MemAlbmInit(0, 0xff, mc_photo_num, 0xff, mc_album_type,
                                    0xff, mc_ctrl.port + 1, 0xff,
                                    (u_char) (mc_ctrl.sel_file + 1));
                ...
                case 2:
                    if (dsp_svp.in_album != 0)
                    {
                        ...
                        sp_load_id =
                            AlbmDesignLoadInGame(0, dsp_svp.atype_buf[0]);
                        sp_load_id =
                            AlbmDesignLoadInGame(1, dsp_svp.atype_buf[1]);
#ifdef BUILD_EU_VERSION
                        sp_load_id =
                            LoadReqLanguage(PL_ALBM_E_PK2, LOAD_ADDRESS_2);
#else
...
#ifdef BUILD_EU_VERSION
                        sp_load_id =
                            LoadReqLanguage(PL_PLDT_E_PK2, LOAD_ADDRESS_4);
                        sp_load_id =
                            LoadReqLanguage(PL_MTOP_E_PK2, LOAD_ADDRESS_2);
#else
            ...
            switch (McAtAlbmChk())
            {
                ...
                case 1:
                    if (dsp_svp.in_album != 0)
                    {
                        ...
                        MemAlbmInit2(dsp_svp.load_side, mc_photo_num,
                                     mc_album_type, mc_ctrl.port + 1,
                                     mc_ctrl.sel_file + 1);
    ...
    if (dsp_svp.msg_alp != 0)
    {
        ...
        alp = (SgSinf(dsp_svp.btn_tmr * (PI * 2) / 60.0f) * dsp_svp.msg_alp
               + dsp_svp.msg_alp)
              * 0.5f;
...
void SavePointMenuModeSlctDisp(u_char msn, u_char csr3, u_char csr4,
                               u_char alp_max, u_char mode)
{
    ...
    PutSpriteYW(PSP_FNT_SP, PSP_FNT_SP, 0.0f, 0.0f, 0.0f, 0x808080, alp_max,
                1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(PSP_FNT_SAVE, PSP_FNT_SAVE, 0.0f, 0.0f, 0.0f, 0x808080, alp_max,
                1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(PSP_FNT_RETURN, PSP_FNT_RETURN, 0.0f, 0.0f, 0.0f, 0x808080,
                alp_max, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);

    switch (mode)
    {
        case 0:
            PutSpriteYW(PSP_FNT_ALBUM, PSP_FNT_ALBUM, 75.0f, 0.0f, 0.0f,
                        0x808080, alp_max, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
            break;
        case 1:
            PutSpriteYW(PSP_FNT_ALBUM, PSP_FNT_ALBUM, 0.0f, 0.0f, 0.0f,
                        0x808080, alp_max, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
            PutSpriteYW(PSP_FNT_FILM, PSP_FNT_FILM, 0.0f, 0.0f, 0.0f, 0x303030,
                        alp_max, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
            break;
        case 2:
            PutSpriteYW(PSP_FNT_ALBUM, PSP_FNT_ALBUM, 0.0f, 0.0f, 0.0f,
                        0x808080, alp_max, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
            PutSpriteYW(PSP_FNT_FILM, PSP_FNT_FILM, 0.0f, 0.0f, 0.0f, 0x808080,
                        alp_max, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
            break;
    }
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        switch (mode)
        {
            case 0:
                if (i == 1)
                {
                    PutSpriteYW(PSP_ICN_ALBUM, PSP_ICN_ALBUM, 75.0f, 0.0f, 0.0f,
                                rgb, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
                }
                else if (i != 2)
                {
                    PutSpriteYW(PSP_ICN_MEMOCA + i, PSP_ICN_MEMOCA + i, 0.0f,
                                0.0f, 0.0f, rgb, alp, 1.0f, 1.0f, 0, 0xff, 1, 0,
                                0);
                }
                break;
            case 1:
                if (i == 2)
                {
                    PutSpriteYW(PSP_ICN_FILM, PSP_ICN_FILM, 0.0f, 0.0f, 0.0f,
                                0x303030, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
                }
                else
                {
                    PutSpriteYW(PSP_ICN_MEMOCA + i, PSP_ICN_MEMOCA + i, 0.0f,
                ...
                break;
            case 2:
                PutSpriteYW(PSP_ICN_MEMOCA + i, PSP_ICN_MEMOCA + i, 0.0f, 0.0f,
                            0.0f, rgb, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
                break;
        }
    }
    ...
    PutSpriteYW(PSP_KAKKO_LU, PSP_KAKKO_LU, csr, 0.0f, 0.0f, 0x808080, alp_max,
                1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(PSP_KAKKO_LD, PSP_KAKKO_LD, csr, 0.0f, 0.0f, 0x808080, alp_max,
                1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(PSP_KAKKO_RU, PSP_KAKKO_RU, csr, 0.0f, 0.0f, 0x808080, alp_max,
                1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(PSP_KAKKO_RD, PSP_KAKKO_RD, csr, 0.0f, 0.0f, 0x808080, alp_max,
                1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    ...
    {
#ifdef BUILD_EU_VERSION
        YesNoCrslOKR(0x14000, csr4 * 132 + 178, 372.0f, 0x808080, alp_max,
                     2.0f);
#else
        YesNoCrslOKR(0x14000, csr4 * 132 + 178, 370.0f, 0x808080, alp_max,
                     2.0f);
#endif
        ...
        {
            PutStringYW(9, dsp_svp.str_no + 3, 320, 333, 0x808080, alp_max,
                        0xf000, 1);
        }
        ...
        switch (spmenu_wrk.csr[3])
        {
            ...
            case 3:
                if (msn == 2)
                {
                    if (ingame_wrk.game == 1)
                    {
                        PutStringYW(9, 22, 320, 333, 0x808080, alp_max, 0xf000,
                                    1);
                    }
                    else
                    {
                        PutStringYW(9, 12, 320, 333, 0x808080, alp_max, 0xf000,
                                    1);
                    }
                }
                else
...
static u_char SaveConte()
{
    ...
    DspMemSavePoint(sv_dsp_sw.msk, sv_dsp_sw.msg, sv_dsp_sw.svp, sv_dsp_sw.fdt,
                    sv_dsp_sw.alt, spmenu_wrk.csr[0], spmenu_wrk.csr[1],
                    spmenu_wrk.csr[2], 0, 0x80, 0);

    return 0;
}

void DspMemSavePoint(u_char msk, u_char msg, u_char fdt, u_char svp, u_char alt,
                     u_char csr0, u_char csr1, u_char csr2, u_char yes_no,
                     u_char alp_max, u_char type)
{
    int i;
    char num;
    u_char flg;
    ...
    if (sv_dsp_sw.svp_alp != 0 && (type != 0 && type != 1))
    {
        for (i = 0; i < 5; i++)
        {
            PutSpriteYW(OA_LD_SML_RNZ, OA_LD_SML_RNZ, 0.0f, i * 59, 0.0f,
                        0x808080, (u_char) (sv_dsp_sw.svp_alp / 100.0f), 1.0f,
                        1.0f, 0, 0xff, 1, 0, 0);
        }
    }
    ...
    if (flg)
    {
        ...
        if (type == 0 || type == 1)
        {
            for (i = num; i < 3; i++)
            {
                PolySquareYW(209.0f, i * 98 + 33, 376, 96, 0, alpha, 1.0f, 1.0f,
                             0xa000, 0, 0, 0);
            }
        }
        else
        {
            for (i = num; i < 5; i++)
            {
                PolySquareYW(209.0f, i * 59 + 33, 376, 54, 0, alpha, 1.0f, 1.0f,
                             0xa000, 0, 0, 0);
            }
        }
    }
    ...
    if (sv_dsp_sw.msg_alp != 0 && msg != 0xff
        && mc_ctrl.step == mc_ctrl.stepbak)
    {
        if (csr0 != 0xff)
        {
            if (mc_ctrl.step == 2)
            {
#ifdef BUILD_EU_VERSION
                YesNoCrslOKR(0x14000, csr0 * 132 + 114, 379.0f, 0x808080,
                             sv_dsp_sw.msg_alp / 100.0f, 2.0f);
#else
                YesNoCrslOKR(0x14000, csr0 * 132 + 114, 378.0f, 0x808080,
                             sv_dsp_sw.msg_alp / 100.0f, 2.0f);
#endif
            }
            else
            {
#ifdef BUILD_EU_VERSION
                YesNoCrslOKR(0x14000, csr0 * 132 + 178, 379.0f, 0x808080,
                             sv_dsp_sw.msg_alp / 100.0f, 2.0f);
#else
                YesNoCrslOKR(0x14000, csr0 * 132 + 178, 376.0f, 0x808080,
                             sv_dsp_sw.msg_alp / 100.0f, 2.0f);
#endif
            }
        }
        ...
        if (mc_ctrl.mode == 2 && mc_ctrl.step == 6)
        {
            if (mc_ctrl.album.sta[mc_ctrl.now_cur] == 3)
            {
                ...
                PolySquareYW(35.0f, 198.0f, 570, 144, 0, alpha, 1.0f, 1.0f,
                             0x4000, 0, 0, 0);
            ...
            {
                PutStringYW(8, msg, 48, 356, 0x808080,
                            sv_dsp_sw.msg_alp / 100.0f, 0xf000, 0);
        ...
        {
            PutStringYW(8, msg, 48, 356, 0x808080, sv_dsp_sw.msg_alp / 100.0f,
                        0xf000, 0);
        }

        if (mcCheckDrawButton(msg) != 0)
        {
            alpha = (SgSinf((btn_flsh_cnt * (PI * 2)) / 60.0f) + 1.0f) * 128.0f
                    * 0.5f;
...
static void WarningMsg(u_char msg, u_char csr0, u_char alp, u_char ha)
{
    ...
    else
    {
...
#else
        PolySquareYW(35.0f, 198.0f, 570, 120, 0, alp, 1.0f, 1.0f, 0x4000, 0, 0,
                     0);
        ...
        {
#ifdef BUILD_EU_VERSION
            YesNoCrslOKR(0x2000, csr0 * 132 + 114, pos_y + 3.0f, 0x808080, ha,
                         2.0f);
#else
            YesNoCrslOKR(0x2000, csr0 * 132 + 114, pos_y + 1.0f, 0x808080, ha,
                         2.0f);
#endif
        }
        else
        {
#ifdef BUILD_EU_VERSION
            YesNoCrslOKR(0x2000, csr0 * 132 + 184, pos_y - 1.0f, 0x808080, ha,
                         2.0f);
#else
            YesNoCrslOKR(0x2000, csr0 * 132 + 184, pos_y + 1.0f, 0x808080, ha,
                         2.0f);
        ...
        if (msg != 0xff)
        {
            ...
            if (mcCheckDrawButton(msg) != 0)
            {
                alpha = (SgSinf((btn_flsh_cnt * (PI * 2)) / 60.0f) + 1.0f)
                        * 128.0f * 0.5f;
...
static void GetSvpNo(u_char *no)
{
    ...
    room_no = GetPointRoomNoFloor(plyr_wrk.move_box.pos[0],
                                  plyr_wrk.move_box.pos[2], map_wrk.floor);
...
static void DspSpLenz(u_char dsp_no, u_char alp)
{
    ...
    PutSpriteYW(SV_LNZ_NO1, SV_LNZ_NO1, 79.0f, 138.0f, 0.0f, 0x808080,
                mrcl_lnz.slot1_alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(SV_LNZ_NO2, SV_LNZ_NO2, 75.0f, 138.0f, 0.0f, 0x808080,
                mrcl_lnz.slot2_alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(PSP_ICN_MEMOCA, PSP_ICN_MEMOCA, -6.0f, -37.0f, 0.0f, 0x808080,
                mrcl_lnz.slot1_alp, 0.85f, 0.85f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(PSP_ICN_MEMOCA, PSP_ICN_MEMOCA, -6.0f, -37.0f, 0.0f, 0x808080,
                mrcl_lnz.slot2_alp, 0.85f, 0.85f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(PSP_END, PSP_END, -441.0f, -41.0f, 0.0f, 0x808080,
                mrcl_lnz.slot3_alp, 0.85f, 0.85f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(SV_LNZ_LNZ, SV_LNZ_LNZ, 22.0f, 77.0f, 0.0f, 0x808080, alp,
                0.85f, 0.85f, 0, 0xff, 1, 0, 0);
}
...
static void DspSpCate(u_char csr1, u_char csr2, u_char alp)
{
    ...
    PutSpriteYW(SV_LNZ_SLT1, SV_LNZ_SLT1, 36.0f, 218.0f, 0.0f, 0x808080, alp,
                1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(SV_LNZ_SLT2, SV_LNZ_SLT2, 36.0f, 256.0f, 0.0f, 0x808080, alp,
                1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(SV_LNZ_HDD3, SV_LNZ_HDD3, 36.0f, 295.0f, 0.0f, 0x808080, alp,
                1.0f, 1.0f, 0, 0xff, 1, 0, 0);
...
static void DspSpData(u_char csr2, u_char alp, u_char type)
{
    ...
    if (type == 0 || type == 1)
    {
        ...
        }
        {
            ...
            for (i = 0; (j = i < 3, j); i++)
            {
                if (1)
                {
                    ...
                    DISP_SQAR dq;
                    register u_long z asm("a1");
                    register u_long t asm("a2");
                    CopySqrDToSqr(&dq, &sq);
                    {
                        register u_int prim asm("a0");
                        u_int x = 0x0fffffff;
                        prim = 0x1000;
                        dq.pri = prim;
                        dq.z = x -= 0x1000;
                    ...
                    t = SCE_GS_SET_TEST_1(1, SCE_GS_ALPHA_ALWAYS, 0,
                                          SCE_GS_AFAIL_KEEP, 0, 0, 1,
                                          SCE_GS_DEPTH_ALWAYS);
                    {
                        dq.zbuf = z;
                        dq.test = t;
        ...
        if (csr_alp != 0.0f)
        {
            PutSpriteYW(0x266, 0x269, 217.0f, pos_y, 0.0f, 0x808080, csr_alp,
                        1.0f, 1.0f, 0, 0xff, 1, 1, 0);
            PutSpriteYW(0x26a, 0x26b, 217.0f, pos_y, 0.0f, 0x808080, csr_alp,
                        6.869565f, 1.0f, 0, 0xff, 1, 1, 0);
        }
        {
            register int j asm("v1");
            for (i = 0; (j = i < 3, j); i++)
    ...
    else
    {
        ...
        if (csr_alp != 0.0f)
        {
            PutSpriteYW(0x2d0, 0x2d0, 0.0f, pos_y, 0.0f, 0x808080, csr_alp,
                        1.0f, 1.0f, 0, 0xff, 1, 0, 0);
            PutSpriteYW(0x2d1, 0x2d1, 0.0f, pos_y, 0.0f, 0x808080, csr_alp,
                        1.0f, 1.0f, 0, 0xff, 1, 0, 0);
        }
    }
    ...
    if (type == 0 || type == 1)
    {
        ...
        for (i = 0; i < 3; i++)
        {
            if (1)
            {
                ...
                dq.test = SCE_GS_SET_TEST_1(1, SCE_GS_ALPHA_ALWAYS, 0,
                                            SCE_GS_AFAIL_KEEP, 0, 0, 1,
                                            SCE_GS_DEPTH_ALWAYS);
                dq.x[2] = dq.x[0] = xx1;
                dq.y[1] = dq.y[0] = yy1 + (i * 0x62);
...
static void DspSpData(u_char csr2, u_char alp, u_char type)
{
    ...
    if (type == 0 || type == 1)
    {
        ...
        if (csr_alp != 0.0f)
        {
            PutSpriteYW(SV_FSL_V01, SV_FSL_V04, 217.0f, pos_y, 0.0f, 0x808080,
                        csr_alp, 1.0f, 1.0f, 0, 0xff, 1, 1, 0);
            PutSpriteYW(SV_FSL_H01, SV_FSL_H02, 217.0f, pos_y, 0.0f, 0x808080,
                        csr_alp, 6.869565f, 1.0f, 0, 0xff, 1, 1, 0);
        }
    }
    else
    {
        ...
        if (csr_alp != 0.0f)
        {
            PutSpriteYW(OA_LD_CSR_L, OA_LD_CSR_L, 0.0f, pos_y, 0.0f, 0x808080,
                        csr_alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
            PutSpriteYW(OA_LD_CSR_R, OA_LD_CSR_R, 0.0f, pos_y, 0.0f, 0x808080,
                        csr_alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
        }
    }
}
...
static void DspSpFile(u_char file_no, u_char pos_y, u_char alp, u_char type)
{
    ...
    PutSpriteYW(SV_LNZ_FILE1, SV_LNZ_FILE1, 206.0f, pos_y + 78, -90.0f,
                0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
}
...
static void DspSpInfo(u_char file_no, u_char pos_y, u_char alp, u_char type)
{
    ...
    PutNumberYW(6, file_no + 1, 218, pos_y + 50, 1.0f, 1.0f, 0x808080, alp,
                0xa000, 2, 0);
    ...
    else
    {
        if (mc_header_buf[file_no].game.msn_flg == 0)
        {
            ...
            {
#ifdef BUILD_EU_VERSION
                PutStringYW(8, mc_header_buf[file_no].game.msn_no + 101, 244,
                            pos_y + 44, 0x808080, alp, 0xa000, 0);
#else
                PutStringYW(8, mc_header_buf[file_no].game.msn_no + 101, 250,
                            pos_y + 46, 0x808080, alp, 0xa000, 0);
#endif
            }
            else
            {
#ifdef BUILD_EU_VERSION
                PutStringYW(8, mc_header_buf[file_no].game.msn_no + 101, 244,
                            pos_y + 44, 0x800000, alp, 0xa000, 0);
#else
                PutStringYW(8, mc_header_buf[file_no].game.msn_no + 101, 250,
                            pos_y + 46, 0x800000, alp, 0xa000, 0);
#endif
            }

#ifdef BUILD_EU_VERSION
            PutStringYW(30, mc_header_buf[file_no].game.room_no, 244,
                        pos_y + 66, 0x808080, alp, 0xa000, 0);
#else
            PutStringYW(30, mc_header_buf[file_no].game.room_no, 250,
                        pos_y + 70, 0x808080, alp, 0xa000, 0);
#endif
            PutNumberYW(0, mc_header_buf[file_no].game.hour, 0xff, pos_y + 91,
                        1.0f, 1.0f, 0x808080, alp, 0xa000, 2, 1);
            PutStringYW(8, 108, 306, pos_y + 91, 0x808080, alp, 0xa000, 0);
            PutNumberYW(0, mc_header_buf[file_no].game.minute, 325, pos_y + 91,
                        1.0f, 1.0f, 0x808080, alp, 0xa000, 2, 1);
            PutStringYW(8, 108, 376, pos_y + 91, 0x808080, alp, 0xa000, 0);
            PutNumberYW(0, mc_header_buf[file_no].game.sec, 395, pos_y + 91,
                        1.0f, 1.0f, 0x808080, alp, 0xa000, 2, 1);
            ...
            if (sv_pht != 0xff)
            {
                ...
                PutSpriteYW(SP_R000 + sv_pht, SP_R000 + sv_pht, 471.0f,
                            pos_y + 50, 0.0f, 0x808080, alp, 1.0f, 1.0f, 0,
                            0xff, 1, 0, 0);
                PutSpriteYW(SV_PHT_V01, SV_PHT_H04, 468.0f, pos_y + 47, 0.0f,
                            0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
#else
                PutSpriteYW(SP_R000 + sv_pht, SP_R000 + sv_pht, 459.0f,
                            pos_y + 50, 0.0f, 0x808080, alp, 1.0f, 1.0f, 0,
                            0xff, 1, 0, 0);
                PutSpriteYW(SV_PHT_V01, SV_PHT_H04, 456.0f, pos_y + 47, 0.0f,
                            0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
#endif
            }
        }
        else
        {
            ...
            {
#ifdef BUILD_EU_VERSION
                PutStringYW(8, end_showzo + 101, 244, pos_y + 44, 0x808080, alp,
                            0xa000, 0);
#else
                PutStringYW(8, end_showzo + 101, 250, pos_y + 46, 0x808080, alp,
                            0xa000, 0);
#endif
            }
            else
            {
#ifdef BUILD_EU_VERSION
                PutStringYW(8, end_showzo + 101, 244, pos_y + 44, 0x800000, alp,
                            0xa000, 0);
#else
                PutStringYW(8, end_showzo + 101, 250, pos_y + 46, 0x800000, alp,
                            0xa000, 0);
#endif
            }
            ...
            if (sv_pht != 0xff)
            {
                ...
                PutSpriteYW(SV_PHT_V01, SV_PHT_H04, 468.0f, pos_y + 47, 0.0f,
                            0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
#else
                PutSpriteYW(SP_R042 + sv_pht, SP_R042 + sv_pht, 459.0f,
                            pos_y + 50, 0.0f, 0x808080, alp, 1.0f, 1.0f, 0,
                            0xff, 1, 0, 0);
                PutSpriteYW(SV_PHT_V01, SV_PHT_H04, 456.0f, pos_y + 47, 0.0f,
                            0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
        ...
        {
#ifdef BUILD_EU_VERSION
            PutSpriteYW(SV_PHT_V01R, SV_PHT_H04R, 468.0f, pos_y + 47, 0.0f,
                        0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
#else
            PutSpriteYW(SV_PHT_V01R, SV_PHT_H04R, 456.0f, pos_y + 47, 0.0f,
                        0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
#endif
        }
    }
...
static void DspSpFile2(u_char file_no, u_char pos_y, u_char alp, u_char type)
{
    ...
    PutSpriteYW(OA_LD_FNT2_SLSH, OA_LD_FNT2_SLSH, -7.0f, pos_y + 2, 0.0f,
                0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
}
...
static void DspSpInfo2(u_char csr_no, u_char pos_y, u_char alp, u_char type)
{
    ...
    switch (mc_ctrl.album.sta[csr_no])
    {
        case 0:
            ...
            PutSpriteYW(OA_LD_FNT2_ALBM, OA_LD_FNT2_ALBM, 0.0f, pos_y, 0.0f,
                        0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
            PutNumberYW(9, no + 1, 319, pos_y + 49, 1.0f, 1.0f, 0x808080, alp,
                        0xa000, 2, 0);
            PutNumberYW(10, mc_header_buf[no].game.msn_no, 443, pos_y + 48,
                        1.0f, 1.0f, 0x808080, alp, 0xa000, 2, 0);
            PutNumberYW(10, 24, 485, pos_y + 48, 1.0f, 1.0f, 0x808080, alp,
                        0xa000, 2, 0);
            PutSpriteYW(OA_LD_OUT_SIR + mc_header_buf[no].game.room_no,
                        OA_LD_OUT_SIR + mc_header_buf[no].game.room_no, 313.0f,
                        pos_y + 1, 0.0f, 0x808080, alp, 0.25f, 0.25f, 0, 0xff,
                        1, 0, 0);
            break;
        case 3:
        ...
        case 9:
            ...
            break;
        case 0xff:
            PutSpriteYW(OA_LD_FNT2_NEW, OA_LD_FNT2_NEW, 0.0f, pos_y, 0.0f,
                        0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
            PutSpriteYW(OA_LD_FNT2_HIFN, OA_LD_FNT2_HIFN, 449.0f, pos_y + 48,
                        0.0f, 0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
            PutSpriteYW(OA_LD_FNT2_HIFN, OA_LD_FNT2_HIFN, 491.0f, pos_y + 49,
                        0.0f, 0x808080, alp, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
            break;
    }
}
...
char AlbmSlct(u_char csr3, u_char step, u_char alp_max, u_char ini)
{
    ...
    switch (step)
    {
        ...
        case 13:
            ...
            for (i = 0; i < 6; i++)
            {
                ...
                {
                    book[i].siz_w =
                        (move.siz_w - init[i].siz_w) * per + init[i].siz_w;
                    book[i].siz_h =
                        (move.siz_h - init[i].siz_h) * per + init[i].siz_h;
                    book[i].pos_x =
                        (move.pos_x - init[i].pos_x) * per + init[i].pos_x;
                    book[i].pos_y =
                        (move.pos_y - init[i].pos_y) * per + init[i].pos_y;
    ...
    PolySquareYW(80.0f, 54.0f, 0x1e0, 0x100, 0, back_alp * 0.5f, 1.0f, 1.0f,
                 0x5000, 0, 0, 0);
...
static void OpenBook(int i, BOOK *book)
{
    ...
    ds.tex1 = SCE_GS_SET_TEX1_1(1, 0, SCE_GS_LINEAR,
...
static void SpSideBar(short int pos_x, short int pos_y, u_char alpha)
{
    PutSpriteYW(SV_LNZ_SCRBAR_BASE_U, SV_LNZ_SCRBAR_BASE_U, pos_x, pos_y, 0.0f,
                0x808080, alpha, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(SV_LNZ_SCRBAR_BASE_D, SV_LNZ_SCRBAR_BASE_D, pos_x, pos_y, 0.0f,
                0x808080, alpha, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
    PutSpriteYW(SV_LNZ_SCRBAR_BASE_M, SV_LNZ_SCRBAR_BASE_M, pos_x, pos_y, 0.0f,
                0x808080, alpha, 1.0f, 26.4f, 0, 0xff, 1, 0, 0);
...
static void SpTrFlsh(short int pos_x, short int pos_y, short int alpha)
{
    PutSpriteYW(SV_LNZ_SCR_TRIANGLE_U, SV_LNZ_SCR_TRIANGLE_D, pos_x, pos_y,
                0.0f, 0x404040, alpha, 1.0f, 1.0f, 0, 0xff, 1, 0, 0);
}

static void DspSaveTitle(u_char type, short int pos_x, short int pos_y,
                         u_char alp, u_char pri)
{
    PutSpriteYW(MNU_CURSOR1, MNU_CURSOR1, pos_x - 15, pos_y - 103, 0.0f,
                0x808080, alp * 0.5f, 1.0f, 1.0f, 0, (u_char) (pri + 4) << 12,
                1, 0, 0);

    switch (type)
    {
        case 0:
            PutSpriteYW(TTL_FNT_SAVE, TTL_FNT_SAVE, pos_x - 15, pos_y, 0.0f,
                        0x808080, alp, 1.0f, 1.0f, 0, (u_char) (pri + 3) << 12,
                        1, 0, 0);
            break;
        case 1:
            PutSpriteYW(TTL_FNT_LOAD, TTL_FNT_LOAD, pos_x - 15, pos_y, 0.0f,
                        0x808080, alp, 1.0f, 1.0f, 0, (u_char) (pri + 3) << 12,
                        1, 0, 0);
            break;
        case 2:
            PutSpriteYW(TTL_FNT_ALBM, TTL_FNT_ALBM, pos_x - 15, pos_y, 0.0f,
                        0x808080, alp, 1.0f, 1.0f, 0, (u_char) (pri + 3) << 12,
                        1, 0, 0);
            break;
    }

    PutSpriteYW(MNU_MAIN_BASE_HOL1, MNU_MAIN_BASE_HOL1, pos_x + 9, pos_y + 27,
                0.0f, 0x808080, alp, 1.0f, 1.0f, 0, (u_char) (pri + 1) << 12, 1,
                0, 0);
    PutSpriteYW(MNU_MAIN_BASE_HOL1, MNU_MAIN_BASE_HOL1, pos_x + 9, pos_y + 65,
                0.0f, 0x808080, alp, 1.0f, 1.0f, 0, (u_char) (pri + 1) << 12, 1,
                0, 0);
    PutSpriteYW(MNU_MAIN_BASE_VAT1, MNU_MAIN_BASE_VAT1_B, pos_x + 16,
                pos_y + 48, 0.0f, 0x808080, alp, 1.0f, 1.0f, 0, pri << 12, 1, 0,
                0);
    PutSpriteYW(MNU_MAIN_BASE_VAT1, MNU_MAIN_BASE_VAT1_B, pos_x + 146,
                pos_y + 48, 0.0f, 0x808080, alp, 1.0f, 1.0f, 0, pri << 12, 1, 0,
                0);
}
            ...
            switch (McAtLoadChk(2))
            {
                ...
                case 1:
                    if (albm_mode.in_album != 0)
                    {
                        ...
                        albm_mode.load_id =
                            AlbmDesignLoadInGame(1, mc_album_type);
#ifdef BUILD_EU_VERSION
                        albm_mode.load_id =
                            LoadReqLanguage(PL_ALBM_E_PK2, LOAD_ADDRESS_2);
#else
...
#ifdef BUILD_EU_VERSION
                    albm_mode.load_id =
                        LoadReqLanguage(PL_SAVE_E_PK2, LOAD_ADDRESS_2);
                    albm_mode.load_id =
                        LoadReqLanguage(PL_ALBM_SAVE_E_PK2, LOAD_ADDRESS_3);
#else
                    albm_mode.load_id = LoadReq(PL_SAVE_PK2, LOAD_ADDRESS_2);
                    albm_mode.load_id =
                        LoadReq(PL_ALBM_SAVE_PK2, LOAD_ADDRESS_3);
#endif
            ...
            switch (McAtAlbmChk())
            {
                ...
                case 1:
                    if (albm_mode.in_album != 0)
                    {
                        ...
                        MemAlbmInit2(albm_mode.load_side, mc_photo_num,
                                     mc_album_type, mc_ctrl.port + 1,
                                     mc_ctrl.sel_file + 1);
