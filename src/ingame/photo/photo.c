...
int SpecialPhotoMakeJudge()
{
    ...
    static int hint_tbl[48] = {
        HINT_00_PK2, HINT_01_PK2, HINT_02_PK2, HINT_03_PK2, HINT_04_PK2,
        HINT_05_PK2, HINT_06_PK2, HINT_07_PK2, HINT_08_PK2, HINT_09_PK2,
        HINT_10_PK2, HINT_11_PK2, HINT_12_PK2, HINT_13_PK2, HINT_14_PK2,
        HINT_15_PK2, HINT_16_PK2, HINT_17_PK2, HINT_18_PK2, HINT_19_PK2,
        HINT_20_PK2, HINT_21_PK2, HINT_22_PK2, HINT_23_PK2, HINT_24_PK2,
        HINT_25_PK2, HINT_26_PK2, HINT_27_PK2, HINT_28_PK2, HINT_29_PK2,
        HINT_30_PK2, HINT_31_PK2, HINT_32_PK2, HINT_33_PK2, HINT_34_PK2,
        HINT_35_PK2, HINT_36_PK2, HINT_37_PK2, HINT_38_PK2, HINT_39_PK2,
        HINT_40_PK2, HINT_41_PK2, HINT_42_PK2, HINT_43_PK2, HINT_44_PK2,
        HINT_45_PK2, HINT_46_PK2, HINT_47_PK2,
    };
    ...
    for (i = 0; i < 5; i++)
    {
        if (photo_wrk.furn[i].type == 64)
        {
            ...
            photo_wrk.spcl_pht_no[count][1] =
                furn_dat[photo_wrk.furn[i].no].fp_mak;
