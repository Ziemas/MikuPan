...
u_int snd_buf_top[] = {0x5400,   0x5F400,  0x68800,  0x78400,  0x84900,
                       0x90E00,  0x9D300,  0x9F600,  0xA1900,  0xA3C00,
                       0xA5F00,  0xA8200,  0xAA500,  0xAC800,  0xAEB00,
                       0xC2F00,  0xD7300,  0x115700, 0x153B00, 0x191F00,
                       0x1A4F00, 0x1B7F00, 0x1BF700, 0x1CC700, 0x1D9700,
                       0x1E6700, 0x1F3700, 0x1F3740, 0x1F6740, 0x1F6780};

// Properties for the voices
...
void ISeInit(int mode)
{
    ...
    sceSdSetSwitch(SD_S_VMIXL | 1, 0xFFFFFFu);
    sceSdSetSwitch(SD_S_VMIXR | 1, 0xFFFFFFu);
    sceSdSetSwitch(SD_S_VMIXEL | 1, 0xFFFFFFu);
    sceSdSetSwitch(SD_S_VMIXER | 1, 0xFFFFFFu);
    sceSdSetParam(SD_P_EVOLL | 1, 0x2FFFu);
    sceSdSetParam(SD_P_EVOLR | 1, 0x2FFFu);
...
static void ISeEfctVol(IOP_COMMAND *icp)
{
    ...
    sceSdSetParam(SD_P_EVOLL | 1, evol);
                              ...
                              int phase)
{
    swsp->tgt_vol_l = swsp->tgt_vol_r =
        ((0x1ff * vol_rate * swsp->param->vol) / 0x1000) >> 2;
