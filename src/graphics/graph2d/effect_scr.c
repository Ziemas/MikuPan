...
/// TODO: IMPLEMENT THIS FUNCTION FOR 2D EFFECTS
u_char SubNowLoading(/* a0 4 */ int fl, /* 0x3440(sp) */ int num, /* f12 50 */ float sclx, /* f28 66 */ float scly, /* f27 65 */ float bx, /* f22 60 */ float by, /* f16 54 */ float spd, /* f29 67 */ float rate, /* f21 59 */ float trate)
{
